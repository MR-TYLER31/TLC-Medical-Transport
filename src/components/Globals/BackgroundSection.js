      ...
      <BackgroundImage className={styleClass} fluid={img}>
        <div className="row">
          <div className="col-12 col-md-12">
            ...
            <h3 className="text-white header">
              Safe, Timely, and Courteous Transportation
            </h3>
            <h1 className="text-white font-weight-bold header">Rest Easy.</h1>
              <Link to="/request"><button className="btn header-btn" style={{ background: "rgb(3, 112, 171)", border: "1px solid white" }}>
